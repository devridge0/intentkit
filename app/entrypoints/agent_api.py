...
@router_rw.post(
    ...
    description=(
        ...
        "The response not include the original user message. It could be skill calls, agent messages, or system error messages. "
        "If the stream mode is requested, the response will be HTTP2 streaming response."
    ),
    tags=["Message"],
)
